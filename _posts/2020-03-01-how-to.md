...
<img src="../assets/img/1-how-to.png" alt="caca" width="100%">

| ![[../assets/img/1-how-to.png|test]] |
|:--:| 
| this is my caption |

> [!bug] 
> plutôt utiliser featuresBruteforce de [[crackmapexec]]
> RDP bruteforce ne fonctionne pas, utiliser Hydra 
...
5. `format:list` will change the layout to a list with border, Refer [[Check [my personal library|[Credits]] ) or while building MoC. 
...
If you want to know my workflow or Obsidian folder structure, check [[.md|here]]

## Features
- Check [[../post/features|Features]] to know theme features
